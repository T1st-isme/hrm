...
export default function EmployeeDetailPage() {
    ...
    const breadcrumbs = [
        ...
        { label: "Employees", href: "/admin/employee" },
        { label: "Detail" },
    ];
    ...
    return (
        <MainLayout title="Employee Detail" breadcrumbs={breadcrumbs}>
            {loading ? (
                <Loading />
            ) : (
                    ...
                    <main className="flex-1 py-6 px-4 lg:px-8">
                        <div className="max-w-8xl mx-auto space-y-6">
                            <div className="flex flex-col md:flex-row gap-6 md:items-center md:justify-between">
                                ...
                                <Button
                                    onClick={(e) =>
                                        handleEdit(employee.id as string, e)
                                    }
                                >
                                    Edit Profile
                                </Button>
